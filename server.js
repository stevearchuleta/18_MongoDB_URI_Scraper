...
// routes
// api endpoints
//  logic to scrape website using cheerio

// A GET route for scraping the gardenanswers.com website
app.get("/scrape", function(req, res) {
  // First, we grab the body of the html with axios
  axios.get("http://www.gardenanswers.com/annuals").then(function(response) {
    ...
    $(".post-content").each(function(i, element) {
      ...
      result.link = $(this)
        ...
        .attr("href");
      result.content = $(this)
        .children(".fusion-post-content-container p")
        .text()
...
// Route for create an Article's as a Note
app.post("/articles/:id", function(req, res) {
  // Create a new note and pass the req.body to the entry
  db.Note.create(req.body)
    .then(function(dbNote) {
